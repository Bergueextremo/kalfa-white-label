...
const benefits = [
  "Varredura de Cláusulas Abusivas",
  "Base de dados STJ e Bacen",
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    isSelected 
                      ? "border-[#3B82F6] bg-blue-50/50 shadow-lg" 
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className={cn(
                      ...
                      isSelected ? "bg-[#3B82F6] text-white" : "bg-slate-100 text-slate-600 group-hover:bg-slate-200"
                    )}>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2">
                        <h3 className={cn(
                          "font-bold text-lg",
                          isSelected ? "text-[#3B82F6]" : "text-[#0A192F]"
                        )}>
                          {contract.title}
                        </h3>
                        <ChevronRight className={cn(
                          "h-5 w-5 flex-shrink-0 transition-transform",
                          isSelected ? "text-[#3B82F6] rotate-90" : "text-slate-400"
                        )} />
                      </div>
                      ...
                      <div className={cn(
                        ...
                        isSelected ? "max-h-24 mt-3 pt-3 border-t border-slate-200" : "max-h-0"
                      )}>
              ...
              <CardContent className="p-6 space-y-6">
                ...
                <div className="min-h-[60px]">
                  {selectedContract ? (
                    ...
                    <div className="flex items-center justify-center p-3 bg-slate-50 rounded-lg border border-dashed border-slate-300 text-sm text-slate-500">
                ...
                <Button 
                  size="lg"
                  className={cn(
                    "w-full py-6 text-base font-bold transition-all duration-200",
                    selectedContract 
