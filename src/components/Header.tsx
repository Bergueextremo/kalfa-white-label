            ...
            <div className="container mx-auto px-4 py-4">
                <div className="flex items-center justify-between">
                    ...
                    <nav className="hidden md:flex items-center gap-8">
                        ...
                        <button onClick={() => navigate('/contratoblindado')} className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
                            Consultas Blindadas
                        </button>
                        <button onClick={() => navigate('/financiamentoblindado')} className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
                            Financiamento
                        </button>
                        <button onClick={() => navigate('/leilaoblindado')} className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
                            Leilão
                        </button>
                        {isAuthenticated && (
                        ...
                        <SheetContent side="right" className="w-[300px] sm:w-[400px]">
                            <nav className="flex flex-col gap-6 mt-8">
                                ...
                                <button
                                    className="text-lg font-medium text-foreground hover:text-primary transition-colors text-left"
                                    onClick={() => {
                                        navigate('/financiamentoblindado');
                                        setMobileMenuOpen(false);
                                    }}
                                >
                                    Financiamento
